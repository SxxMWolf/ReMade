...
public class FriendshipController {
    ...
    public ResponseEntity<?> getFriendCount(@PathVariable("userId") String userId) {
        try {
    ...
    public ResponseEntity<?> getPendingFriendRequestCount(@PathVariable("userId") String userId) {
        try {
